...
import com.ivb.flixster.constants.constant;
import com.ivb.flixster.database.favouritesSqliteHelper;
import com.ivb.flixster.modal.movieGeneralModal;
import com.ivb.flixster.modal.review.Results;
import com.ivb.flixster.modal.review.movieReview;
import com.ivb.flixster.modal.trailer.movieYoutubeModal;
import com.ivb.flixster.network.MovieAPI;
import com.ivb.flixster.network.NetworkAPI;
    ...
    protected void getTrailer(final LinearLayout youtubeViewHolder) {
        ...
        mMovieAPI.fetchVideos(constant.ACCESS_TOKEN, this.moviegeneralModal.getmId(), new Callback<movieYoutubeModal>() {
            ...
            public void success(movieYoutubeModal movieYoutubeModal, Response response) {
                ...
                com.ivb.flixster.modal.trailer.Results[] trailer = movieYoutubeModal.getResults();
                if (trailer.length > 0) {
                    shareYoutubeID = trailer[0].getKey();
                    for (final com.ivb.flixster.modal.trailer.Results obj : trailer) {
